...
// // ]);
//
const submodulePath = path.resolve(__dirname, 'packages');
//
...
const packName = `kanaries-graphic-walker-v0.4.10.tgz`;

const packPath = path.resolve(submodulePath, packName);
